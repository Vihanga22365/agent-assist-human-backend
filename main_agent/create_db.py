...
# === User U002 Credit Cards (1 card) ===
cursor.execute("""INSERT INTO credit_card_details (UserID, CreditCard, Last4Numbers, CreditLimit, AvailableLimit, AnnualFee) 
VALUES ('U002', 'Chase Sapphire Reserve', '9876', 50000.00, 35000.00, 550.00)""")

# === User U003 Credit Cards (2 cards) ===
cursor.execute("""INSERT INTO credit_card_details (UserID, CreditCard, Last4Numbers, CreditLimit, AvailableLimit, AnnualFee) 
VALUES ('U003', 'Chase Freedom Flex', '2468', 5000.00, 4500.00, 0.00)""")
cursor.execute("""INSERT INTO credit_card_details (UserID, CreditCard, Last4Numbers, CreditLimit, AvailableLimit, AnnualFee) 
VALUES ('U003', 'Chase Slate Edge', '1357', 3000.00, 2800.00, 0.00)""")
...
# === User U002 Wave Offs (0 wave offs) ===
# No wave offs for U002

# === User U003 Wave Offs (2 wave offs) ===
cursor.execute("""INSERT INTO credit_card_late_fee_wave_off (UserID, Last4Numbers, CreditCardID, WaveOffMonth, WaveOffYear, Reason) 
VALUES ('U003', '2468', 4, 1, 2025, 'First time late payment courtesy waiver')""")
cursor.execute("""INSERT INTO credit_card_late_fee_wave_off (UserID, Last4Numbers, CreditCardID, WaveOffMonth, WaveOffYear, Reason) 
VALUES ('U003', '2468', 4, 4, 2025, 'Financial hardship consideration')""")
